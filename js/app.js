...
if(needsTc){els.video.classList.remove("active");els.placeholder.style.display="block";els.placeholder.innerHTML="<p>❌ Формат не поддерживается</p><p class='hint'>"+file.name+" — требуется FFmpeg WASM</p>";}
}
