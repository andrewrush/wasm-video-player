...
els.placeholder.style.display='none';els.video.classList.add('active');els.canvas.classList.remove('active');state.transcodedBlobUrl=URL.createObjectURL(blob);
